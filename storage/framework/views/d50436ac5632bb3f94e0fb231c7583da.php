<?php $__env->startSection('title', 'Analytics | FabKin Admin & Dashboards Template'); ?>
<?php $__env->startSection('title-sub', 'Dashboard'); ?>
<?php $__env->startSection('pagetitle', 'Analytics'); ?>
                    ...
                    <div class="card-body py-3 d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-1 text-primary">
                                <i class="bi bi-heart-pulse me-2"></i>Bienvenue, <?php echo e(Auth::user()->name); ?> !
                            </h4>
                            <p class="mb-0 text-muted">
                                <i class="bi bi-envelope me-1"></i><?php echo e(Auth::user()->email); ?> |
                                <i class="bi bi-envelope me-1"></i><?php echo e(Auth::user()->role); ?> |

                                <i class="bi bi-clock me-1"></i>Connecté depuis : <?php echo e(now()->format('d/m/Y à H:i')); ?>
...
<?php echo $__env->make('partials.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/dashboard-analytics.blade.php ENDPATH**/ ?>