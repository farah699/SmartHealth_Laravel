<?php $__env->startSection('title', 'Questionnaires Psychologiques | SmartHealth'); ?>
<?php $__env->startSection('title-sub', 'Évaluation'); ?>
<?php $__env->startSection('pagetitle', 'Questionnaires'); ?>
...
function startAssessment() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "<?php echo e(route('questionnaires.start')); ?>";
        }
    });
}
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('partials.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/questionnaires/index.blade.php ENDPATH**/ ?>