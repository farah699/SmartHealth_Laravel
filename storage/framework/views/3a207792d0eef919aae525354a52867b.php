    ...
    <div class="pe-app-sidebar-logo px-6 d-flex align-items-center position-relative">
        <!--begin::Brand Image-->
         <a href="index" class="fs-18 fw-semibold">
            <img height="30" class="pe-app-sidebar-logo-default d-none" alt="Logo" src="<?php echo e(asset('assets/images/logo-dark.png')); ?>">
            <img height="30" class="pe-app-sidebar-logo-light d-none" alt="Logo" src="<?php echo e(asset('assets/images/logo-light.png')); ?>">
            <img height="30" class="pe-app-sidebar-logo-minimize d-none" alt="Logo" src="<?php echo e(asset('assets/images/logo-md.png')); ?>">
            <img height="30" class="pe-app-sidebar-logo-minimize-light d-none" alt="Logo" src="<?php echo e(asset('assets/images/logo-md-light.png')); ?>">
            <!-- FabKin -->
        </a>
        <!--end::Brand Image-->
    </div> 
...
<li class="pe-slide">
    <a href="<?php echo e(route('questionnaires.index')); ?>" class="pe-nav-link">
        <i class="bi bi-clipboard-check pe-nav-icon"></i>
        <span class="pe-nav-content">Questionnaire</span>
    </a>
</li>
<li class="pe-slide">
    <a href="<?php echo e(route('questionnaires.history')); ?>" class="pe-nav-link">
        <i class="bi bi-clock-history pe-nav-icon"></i>
        <span class="pe-nav-content">Historique</span>
    </a>
</li>
...
<li class="pe-slide pe-has-sub">
    <a href="#collapseActivities" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseActivities">
        <i class="bi bi-heart-pulse pe-nav-icon"></i>
        <span class="pe-nav-content">Activities</span>
        <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
    </a>
    <ul class="pe-slide-menu collapse" id="collapseActivities">
        <li class="slide pe-nav-content1">
            <a href="javascript:void(0)">Activités sportive</a>
        </li>
        <li class="pe-slide-item">
            <a href="<?php echo e(route('activities.index')); ?>" class="pe-nav-link <?php echo e(request()->routeIs('activities.index') ? 'active' : ''); ?>">
                Mes Activités
            </a>
        </li>
        <li class="pe-slide-item">
            <a href="<?php echo e(route('activities.create')); ?>" class="pe-nav-link <?php echo e(request()->routeIs('activities.create') ? 'active' : ''); ?>">
                Ajouter Activité
            </a>
        </li>
        <li class="pe-slide-item">
    <a href="<?php echo e(route('activities.statistics')); ?>" class="pe-nav-link <?php echo e(request()->routeIs('activities.statistics') ? 'active' : ''); ?>">
        ...
        <li class="pe-slide-item">
            <a href="<?php echo e(route('imc.index')); ?>" class="pe-nav-link <?php echo e(request()->routeIs('imc.index') ? 'active' : ''); ?>">
                <i class="bi bi-calculator"></i>
                <span class="pe-nav-content">Calculateur IMC</span>
            </a>
        </li>

<li class="pe-slide">
    <a href="<?php echo e(route('exercises.recommendations')); ?>" class="pe-nav-link <?php echo e(request()->routeIs('exercises.recommendations') ? 'active' : ''); ?>">
        <i class="bi bi-robot pe-nav-icon"></i>
        <span class="pe-nav-content">🤖 Recommandations IA</span>
    </a>
</li>
            ...
            <li class="pe-slide">
                <a href="<?php echo e(route('admin.user-stats')); ?>" class="pe-nav-link">
                    <i class="bi bi-people pe-nav-icon"></i>
                    <span class="pe-nav-content">Statistiques Utilisateurs</span>
                </a>
            </li>
            <li class="pe-slide">
                <a href="<?php echo e(route('resources.admin')); ?>" class="pe-nav-link">
                    <i class="bi bi-gear pe-nav-icon"></i>
                    <span class="pe-nav-content">Gérer Ressources</span>
                </a>
            </li>
            <?php endif; ?>
...
<li class="pe-slide">
    <a href="<?php echo e(route('yoga.practice')); ?>" class="pe-nav-link">
        <i class="bi bi-person-arms-up pe-nav-icon"></i>
        <span class="pe-nav-content">Yoga IA</span>
    </a>
</li>
...
<li class="pe-slide">
    <a href="<?php echo e(route('blogs.index')); ?>" class="pe-nav-link">
        <i class="bi bi-journal-text pe-nav-icon"></i>
        <span class="pe-nav-content">Tous les Blogs</span>
    </a>
</li>

<li class="pe-slide">
    <a href="<?php echo e(route('blogs.create')); ?>" class="pe-nav-link">
        <i class="bi bi-plus-circle pe-nav-icon"></i>
        <span class="pe-nav-content">Créer un Blog</span>
    </a>
</li>

<li class="pe-slide">
    <a href="<?php echo e(route('recommendations.index')); ?>" class="pe-nav-link">
        <i class="bi bi-lightbulb pe-nav-icon"></i>
        <span class="pe-nav-content">Recommandations</span>
    </a>
</li>
          ...
          <li class="pe-menu-title">
            ...
            <li class="pe-slide pe-has-sub">
                <a href="#collapseNutrition" class="pe-nav-link" data-bs-toggle="collapse" aria-expanded="false" aria-controls="collapseNutrition">
                    <i class="bi bi-heart-pulse pe-nav-icon"></i>
                    <span class="pe-nav-content">Nutrition</span>
                    <i class="ri-arrow-down-s-line pe-nav-arrow"></i>
                </a>
                <ul class="pe-slide-menu collapse" id="collapseNutrition">
                    <li class="slide pe-nav-content1">
                        <a href="javascript:void(0)">Nutrition</a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="<?php echo e(route('nutrition.dashboard')); ?>" class="pe-nav-link">
                            <i class="bi bi-activity"></i>
                            <span class="pe-nav-content">Personal Tracking</span>
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="<?php echo e(route('nutrition.history')); ?>" class="pe-nav-link">
                            <i class="bi bi-clock-history"></i>
                            <span class="pe-nav-content">Historique</span>
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="<?php echo e(route('nutrition.profile')); ?>" class="pe-nav-link">
                            <i class="bi bi-person-gear"></i>
                            <span class="pe-nav-content">Personal Data</span>
                        </a>
                    </li>
                </ul>
            </li>            <li class="pe-slide">
                <a href="<?php echo e(route('resources.index')); ?>" class="pe-nav-link">
                    <i class="bi bi-info-circle pe-nav-icon"></i>
                    <span class="pe-nav-content">Ressources</span>
                </a>
            </li>
