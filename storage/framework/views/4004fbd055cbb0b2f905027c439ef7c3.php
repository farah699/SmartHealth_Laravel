...
<?php $__env->startSection('title', 'Ajouter une activité | SmartHealth'); ?>
<?php $__env->startSection('title-sub', 'Activités Sportives'); ?>
<?php $__env->startSection('pagetitle', 'Ajouter une activité'); ?>

<?php $__env->startSection('css'); ?>
<link rel="stylesheet" href="<?php echo e(asset('assets/libs/flatpickr/flatpickr.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/libs/tom-select/tom-select.min.css')); ?>">
<!-- SweetAlert2 CSS -->
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('activities.index')); ?>" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('activities.store')); ?>" method="POST" id="activityForm">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        <input type="radio" 
                                               class="btn-check" 
                                               name="type" 
                                               id="type_<?php echo e($key); ?>" 
                                               value="<?php echo e($key); ?>"
                                               <?php echo e(old('type') == $key ? 'checked' : ''); ?>>
                                        <label class="btn btn-outline-<?php echo e($type['color']); ?> w-100 p-3" for="type_<?php echo e($key); ?>">
                                            <i class="<?php echo e($type['icon']); ?> fs-4 d-block mb-1"></i>
                                            <small><?php echo e($type['name']); ?></small>
                                        </label>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select form-select-lg <?php $__errorArgs = ['intensity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $intensityLevels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $intensity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" 
                                                <?php echo e(old('intensity') == $key ? 'selected' : ''); ?>

                                                data-description="<?php echo e($intensity['description']); ?>">
                                            <?php echo e($intensity['name']); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <small class="form-text text-muted" id="intensityDescription"></small>
                                <?php $__errorArgs = ['intensity'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="card bg-info-subtle">
                                    <div class="card-body">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="is_recurring" name="is_recurring" value="1" <?php echo e(old('is_recurring') ? 'checked' : ''); ?>>
                                        ...
                                        <div id="recurring-options" class="mt-3" style="display: <?php echo e(old('is_recurring') ? 'block' : 'none'); ?>;">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-select <?php $__errorArgs = ['target_sessions_per_week'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                        ...
                                                        <option value="1" <?php echo e(old('target_sessions_per_week') == '1' ? 'selected' : ''); ?>>1 session/semaine</option>
                                                        <option value="2" <?php echo e(old('target_sessions_per_week') == '2' ? 'selected' : ''); ?>>2 sessions/semaine</option>
                                                        <option value="3" <?php echo e(old('target_sessions_per_week', '3') == '3' ? 'selected' : ''); ?>>3 sessions/semaine</option>
                                                        <option value="4" <?php echo e(old('target_sessions_per_week') == '4' ? 'selected' : ''); ?>>4 sessions/semaine</option>
                                                        <option value="5" <?php echo e(old('target_sessions_per_week') == '5' ? 'selected' : ''); ?>>5 sessions/semaine</option>
                                                        <option value="6" <?php echo e(old('target_sessions_per_week') == '6' ? 'selected' : ''); ?>>6 sessions/semaine</option>
                                                        <option value="7" <?php echo e(old('target_sessions_per_week') == '7' ? 'selected' : ''); ?>>Tous les jours</option>
                                                    </select>
                                                    <?php $__errorArgs = ['target_sessions_per_week'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" class="form-control <?php $__errorArgs = ['activity_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                                           ...
                                                           value="<?php echo e(old('activity_description')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div id="single-session-info" class="mt-2" style="display: <?php echo e(old('is_recurring') ? 'none' : 'block'); ?>;">
                            ...
                            <div id="session-details">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" 
                                           class="form-control form-control-lg <?php $__errorArgs = ['activity_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                           id="activity_date" 
                                           name="activity_date" 
                                           value="<?php echo e(old('activity_date', date('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="number" 
                                           class="form-control form-control-lg <?php $__errorArgs = ['distance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 mb-4">
                                    ...
                                    <input type="number" 
                                           class="form-control form-control-lg <?php $__errorArgs = ['calories'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select class="form-select" id="weather" name="weather">
                                                        <option value="">Choisir...</option>
                                                        <option value="ensoleille" <?php echo e(old('weather') == 'ensoleille' ? 'selected' : ''); ?>>☀️ Ensoleillé</option>
                                                        <option value="nuageux" <?php echo e(old('weather') == 'nuageux' ? 'selected' : ''); ?>>☁️ Nuageux</option>
                                                        <option value="pluvieux" <?php echo e(old('weather') == 'pluvieux' ? 'selected' : ''); ?>>🌧️ Pluvieux</option>
                                                        <option value="venteux" <?php echo e(old('weather') == 'venteux' ? 'selected' : ''); ?>>💨 Venteux</option>
                                                        <option value="froid" <?php echo e(old('weather') == 'froid' ? 'selected' : ''); ?>>❄️ Froid</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="description" 
                                              rows="4"
                                              placeholder="Décrivez votre séance, vos sensations, le parcours..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                    <a href="<?php echo e(route('activities.index')); ?>" class="btn btn-light btn-lg">
...
<script src="<?php echo e(asset('assets/libs/tom-select/tom-select.min.js')); ?>"></script>
<!-- SweetAlert2 JS -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('partials.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/activities/create.blade.php ENDPATH**/ ?>