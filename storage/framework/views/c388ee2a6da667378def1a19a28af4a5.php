<?php $__env->startSection('title', 'Pratique de Yoga | SmartHealth'); ?>
<?php $__env->startSection('title-sub', 'Yoga IA'); ?>
<?php $__env->startSection('pagetitle', 'Détection de poses'); ?>
            ...
            <div class="stats-card">
                ...
                <div class="mt-3">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong><?php echo e($stats->total_points); ?></strong>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span>Séances:</span>
                        <strong><?php echo e($stats->total_sessions); ?></strong>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span>Niveau:</span>
                        <strong><?php echo e($stats->level); ?></strong>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span>Série actuelle:</span>
                        <strong><?php echo e($stats->current_streak); ?> jours</strong>
                    </div>
                </div>
            </div>
...
class YogaSession {
    ...
    async startSession() {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("yoga.start")); ?>', {
                method: 'POST',
                headers: {
    ...
    async endSession() {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("yoga.end")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
    ...
    async detectPose() {
        ...
        try {
            ...
            const response = await fetch('<?php echo e(route("yoga.detect")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('partials.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/yoga/practice.blade.php ENDPATH**/ ?>