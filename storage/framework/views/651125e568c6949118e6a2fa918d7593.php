<?php $__env->startSection('title', 'Nutrition Dashboard | SmartHealth'); ?>
...
<div class="container-fluid">
    ...
    <?php if(!$user->hasCompleteProfile()): ?>
        <div class="alert alert-warning">
            ...
            <a href="<?php echo e(route('nutrition.profile')); ?>" class="btn btn-sm btn-warning">Complete my profile</a>
        </div>
    <?php endif; ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0"><?php echo e(number_format($summary->total_calories, 0)); ?></h3>
                            <p class="text-muted">/ <?php echo e(number_format($summary->calorie_goal, 0)); ?> kcal</p>
                        </div>
                        <div class="align-self-center">
                            <div class="progress-circle calorie-circle" 
                                 style="--progress-deg: <?php echo e(min(360, $summary->calorie_percentage * 3.6)); ?>deg; 
                                        background: conic-gradient(#727cf5 0deg <?php echo e(min(360, $summary->calorie_percentage * 3.6)); ?>deg, #e9ecef <?php echo e(min(360, $summary->calorie_percentage * 3.6)); ?>deg 360deg);">
                                <div class="progress-circle-inner">
                                    <?php echo e(number_format($summary->calorie_percentage, 0)); ?>%
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="progress mt-2">
                        <div class="progress-bar bg-primary" style="width: <?php echo e(min(100, $summary->calorie_percentage)); ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h3 class="mb-0" id="water-total"><?php echo e(number_format($summary->total_water_ml, 0)); ?> ml</h3>
                            <p class="text-muted">/ <?php echo e(number_format($summary->water_goal_ml, 0)); ?> ml</p>
                        </div>
                        <div class="align-self-center">
                            <div class="progress-circle water-circle" id="water-circle"
                                 style="--progress-deg: <?php echo e(min(360, $summary->water_percentage * 3.6)); ?>deg; 
                                        background: conic-gradient(#17a2b8 0deg <?php echo e(min(360, $summary->water_percentage * 3.6)); ?>deg, #e9ecef <?php echo e(min(360, $summary->water_percentage * 3.6)); ?>deg 360deg);">
                                <div class="progress-circle-inner" id="water-percentage">
                                    <?php echo e(number_format($summary->water_percentage, 0)); ?>%
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="progress mt-2">
                        <div class="progress-bar bg-info" id="water-progress" style="width: <?php echo e(min(100, $summary->water_percentage)); ?>%"></div>
                    </div>
                    
                    <div class="mt-2" id="water-status">
                        <?php if($summary->water_percentage >= 100): ?>
                            <small class="text-success"><i class="mdi mdi-check-circle me-1"></i>Goal achieved! 🎉</small>
                        <?php elseif($summary->water_percentage >= 80): ?>
                            <small class="text-warning"><i class="mdi mdi-clock-outline me-1"></i>Almost there! <?php echo e(number_format($summary->water_goal_ml - $summary->total_water_ml)); ?> ml remaining</small>
                        <?php else: ?>
                            <small class="text-info"><i class="mdi mdi-information-outline me-1"></i><?php echo e(number_format($summary->water_goal_ml - $summary->total_water_ml)); ?> ml remaining</small>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <a href="<?php echo e(route('nutrition.profile')); ?>" class="btn btn-soft-secondary w-100 mb-2">
                                <i class="mdi mdi-account-cog me-1"></i>
                                Edit profile
                            </a>
                        </div>
                        <div class="col">
                            <a href="<?php echo e(route('nutrition.history')); ?>" class="btn btn-soft-warning w-100 mb-2">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if($todayHydrationEntries->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $todayHydrationEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($entry->drink_type_label); ?></td>
                                            <td><strong><?php echo e($entry->formatted_amount); ?></strong></td>
                                            <td><?php echo e($entry->entry_time->format('H:i')); ?></td>
                                            <td>
                                                <form method="POST" action="<?php echo e(route('nutrition.hydration.delete', $entry->id)); ?>" style="display: inline;">
                                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div>
                                <strong>Total: <?php echo e(number_format($todayHydrationEntries->sum('amount_ml'), 0)); ?> ml</strong>
                            </div>
                            <small class="text-muted"><?php echo e($todayHydrationEntries->count()); ?> entries</small>
                        </div>
                    <?php else: ?>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if($todayFoodEntries->count() > 0): ?>
                        <div class="table-responsive">
                            <table class="table table-sm table-hover">
                                <thead class="table-light">
                                    <tr>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $todayFoodEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <strong><?php echo e($entry->food_name); ?></strong>
                                                <?php if(isset($entry->brand_name) && $entry->brand_name): ?>
                                                    <br><small class="text-muted"><?php echo e($entry->brand_name); ?></small>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php switch($entry->meal_type):
                                                    case ('breakfast'): ?>
                                                    ...
                                                    <?php case ('snack'): ?>
                                                        ...
                                                        <?php break; ?>
                                                    <?php default: ?>
                                                        <span class="badge bg-secondary"><?php echo e($entry->meal_type); ?></span>
                                                <?php endswitch; ?>
                                            </td>
                                            <td><?php echo e($entry->quantity); ?> <?php echo e($entry->unit); ?></td>
                                            <td><strong><?php echo e(number_format($entry->total_calories, 0)); ?> kcal</strong></td>
                                            <td>
                                                <form method="POST" action="<?php echo e(route('nutrition.food.delete', $entry->id)); ?>" style="display: inline;">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="submit" class="btn btn-sm btn-outline-danger" 
                                                            onclick="return confirm('Delete this entry?')">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <div>
                                <strong>Total: <?php echo e(number_format($todayFoodEntries->sum('total_calories'), 0)); ?> kcal</strong>
                            </div>
                            <small class="text-muted"><?php echo e($todayFoodEntries->count()); ?> entries</small>
                        </div>
                    <?php else: ?>
                        <div class="text-center py-4">
...
<div class="modal fade" id="addWaterModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="<?php echo e(route('nutrition.hydration.store')); ?>">
                <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.quick-water').forEach(button => {
        button.addEventListener('click', function() {
            ...
            fetch('<?php echo e(route("nutrition.hydration.quick")); ?>', {
                method: 'POST',
                headers: {
...
function searchFoods(query) {
    ...
    fetch(`<?php echo e(route('nutrition.food.search')); ?>?q=${encodeURIComponent(query)}`)
        .then(response => response.json())
        .then(data => {
...
function calculateNutrition() {
    ...
    fetch('<?php echo e(route("nutrition.food.calculate-nutrition")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
function submitFoodEntry() {
    ...
    fetch('<?php echo e(route("nutrition.food.store")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
function updateWaterDisplay(newTotal) {
    const goal = <?php echo e($summary->water_goal_ml); ?>;
...
<?php echo $__env->make('partials.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/nutrition/dashboard.blade.php ENDPATH**/ ?>