                    ...
                    <div class="card-body py-3 d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-1 text-primary">
                                <i class="bi bi-heart-pulse me-2"></i>Bienvenue, {{ Auth::user()->name }} !
                            </h4>
                            <p class="mb-0 text-muted">
                                <i class="bi bi-envelope me-1"></i>{{ Auth::user()->email }} |
                                <i class="bi bi-envelope me-1"></i>{{ Auth::user()->role }} |

                                <i class="bi bi-clock me-1"></i>Connecté depuis : {{ now()->format('d/m/Y à H:i') }}
                            </p>
                        </div>
