        ...
        <div class="d-flex align-items-center">
            ...
            <div class="me-auto">
                <div class="d-inline-flex align-items-center gap-5">
                    <!-- Logo -->
                    <a href="{{ url('index') }}" class="fs-18 fw-semibold">
...
<div class="dropdown pe-dropdown-mega d-none d-md-block">
    ...
    <div class="dropdown-menu dropdown-mega-md header-dropdown-menu pe-noti-dropdown-menu p-0" id="notificationDropdown">
        ...
        <div class="border-top p-3 text-center">
            <a href="{{ route('notifications.index') }}" class="text-primary">Voir toutes les notifications</a>
        </div>
    </div>
</div>
...
@endauth
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    <button class="header-profile-btn btn gap-1 text-start" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="header-btn btn position-relative">
                            @if(Auth::user()->avatar)
                                <img src="{{ asset('storage/' . Auth::user()->avatar) }}" alt="Avatar Image" class="img-fluid rounded-circle" style="width: 32px; height: 32px; object-fit: cover;">
                            @else
                                <div class="rounded-circle bg-primary d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
                                    <span class="text-white fs-12 fw-bold">{{ substr(Auth::user()->name, 0, 2) }}</span>
                                </div>
                            @endif
                        ...
                        <div class="d-none d-lg-block pe-2">
                            <span class="d-block mb-0 fs-13 fw-semibold">{{ Str::limit(Auth::user()->name, 15) }}</span>
                            <span class="d-block mb-0 fs-12 text-muted">
                                @if(Auth::user()->bio)
                                    {{ Str::limit(Auth::user()->bio, 20) }}
                                @else
                                    Membre SmartHealth
                                @endif
                            </span>
                    ...
                    <div class="dropdown-menu dropdown-mega-sm header-dropdown-menu p-3">
                        ...
                        <div class="border-bottom pb-2 mb-2 d-flex align-items-center gap-2">
                            @if(Auth::user()->avatar)
                                <img src="{{ asset('storage/' . Auth::user()->avatar) }}" alt="Avatar Image" class="avatar-md rounded-circle" style="object-fit: cover;">
                            @else
                                <div class="avatar-md rounded-circle bg-primary d-flex align-items-center justify-content-center">
                                    <span class="text-white fs-16 fw-bold">{{ substr(Auth::user()->name, 0, 2) }}</span>
                                </div>
                            @endif
                            <div>
                        ...
                        <ul class="list-unstyled mb-1 border-bottom pb-1">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('profile.edit') }}#profile-password">
                        ...
                        <div class="border-top pt-2 mt-2 text-center">
                            <small class="text-muted">
                                ...
                                @if(Auth::user()->birth_date)
                                    <br>{{ Auth::user()->birth_date->age }} ans
                                @endif
                            </small>
                        </div>
                    </div>
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="{{ route('register') }}" class="btn btn-outline-primary btn-sm d-none d-lg-inline-block">
                        S'inscrire
                    </a>
                </div>
                @endauth
