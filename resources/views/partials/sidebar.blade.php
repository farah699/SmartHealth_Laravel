...
<li class="pe-slide pe-has-sub">
    ...
    <ul class="pe-slide-menu collapse" id="collapseActivities">
        ...
        <li class="pe-slide-item">
            <a href="{{ route('activities.index') }}" class="pe-nav-link {{ request()->routeIs('activities.index') ? 'active' : '' }}">
                Mes Activités
            </a>
        </li>
        <li class="pe-slide-item">
            <a href="{{ route('activities.create') }}" class="pe-nav-link {{ request()->routeIs('activities.create') ? 'active' : '' }}">
                Ajouter Activité
            </a>
        </li>
        <li class="pe-slide-item">
    <a href="{{ route('activities.statistics') }}" class="pe-nav-link {{ request()->routeIs('activities.statistics') ? 'active' : '' }}">
        ...
        <li class="pe-slide-item">
            <a href="{{ route('imc.index') }}" class="pe-nav-link {{ request()->routeIs('imc.index') ? 'active' : '' }}">
...
<li class="pe-slide">
    <a href="{{ route('exercises.recommendations') }}" class="pe-nav-link {{ request()->routeIs('exercises.recommendations') ? 'active' : '' }}">
        ...
        <span class="pe-nav-content">🤖 Recommandations IA</span>
            ...
            <li class="pe-slide">
                <a href="{{ route('admin.user-stats') }}" class="pe-nav-link">
                    <i class="bi bi-people pe-nav-icon"></i>
                    <span class="pe-nav-content">Statistiques Utilisateurs</span>
                </a>
            </li>
            <li class="pe-slide">
                <a href="{{ route('resources.admin') }}" class="pe-nav-link">
...
<li class="pe-slide">
    <a href="{{ route('yoga.practice') }}" class="pe-nav-link">
...
<li class="pe-slide">
    <a href="{{ route('blogs.index') }}" class="pe-nav-link">
...
<li class="pe-slide">
    <a href="{{ route('blogs.create') }}" class="pe-nav-link">
...
<li class="pe-slide">
    <a href="{{ route('recommendations.index') }}" class="pe-nav-link">
          ...
          <li class="pe-menu-title">
            ...
            <li class="pe-slide pe-has-sub">
                ...
                <ul class="pe-slide-menu collapse" id="collapseNutrition">
                    ...
                    <li class="pe-slide-item">
                        <a href="{{ route('nutrition.dashboard') }}" class="pe-nav-link">
                            <i class="bi bi-activity"></i>
                            <span class="pe-nav-content">Personal Tracking</span>
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="{{ route('nutrition.history') }}" class="pe-nav-link">
                            <i class="bi bi-clock-history"></i>
                            <span class="pe-nav-content">Historique</span>
                        </a>
                    </li>
                    <li class="pe-slide-item">
                        <a href="{{ route('nutrition.profile') }}" class="pe-nav-link">
                ...
                <a href="{{ route('resources.index') }}" class="pe-nav-link">
