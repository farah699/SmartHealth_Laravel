...
@section('title', 'Verify Registration | SmartHealth')
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                <div class="card mx-xxl-8">
                    <div class="card-body py-12 px-8">
                        ...
                        <form id="otpForm" method="POST" action="{{ route('register.verify.otp.submit') }}">
                            @csrf
                            ...
                            <p class="text-center mb-0 mt-2">
                                <a href="{{ route('register') }}" class="link link-primary text-body fw-medium fs-12">
